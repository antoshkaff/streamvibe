...
import FooterNavigationList from '@/components/UI/Footer/components/FooterNavigationList/FooterNavigationList.jsx';
...
const Footer = () => {
    ...
    const moviesList = {
        title: 'Movies',
        items: [
            { name: 'Genres', link: '/movies#categories' },
            { name: 'Trending', link: '/movies#trending' },
            { name: 'New Release', link: '/movies#new' },
    ...
    const showsList = {
        title: 'Shows',
        items: [
            { name: 'Genres', link: '/movies#categoriesTv' },
            { name: 'Trending', link: '/movies#trendingTv' },
            { name: 'New Release', link: '/movies#releasesTv' },
            { name: 'Popular', link: '/movies#popularTv' },
        ],
    };

    const supportList = {
        title: 'Support',
        items: [{ name: 'Contact Us', link: '/support#contact-us' }],
    };

    const subscriptionList = {
        title: 'Subscription',
        items: [
            { name: 'Plans', link: '/subscriptions#plans' },
            { name: 'Features', link: '/subscriptions#features' },
        ],
    };
        ...
        <footer className={styles.footer}>
            <Container className={styles.footerContainer}>
                <div className={styles.footer__inner}>
                    {[
                        ...
                        <FooterNavigationList
                            ...
                            items={items}
                            key={index}
                            titleStyles={styles.listTitle}
                            listStyles={styles.list}
                            containerStyles={styles.listContainer}
                        />
                    ))}
                    <div className={styles.listContainer}>
                        <h3 className={styles.listTitle}>Connect With Us</h3>
                ...
                <div className={styles.footer__bottom}>
                    <CustomLink className={styles.bottomLink} href={'/'}>
